...
public class addinterest extends javax.swing.JFrame {
    ...
    public addinterest(String email, String username) {
        this.email = email;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("interest.jpg")); // NOI18N
    ...
    private void findfriendActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:

    }    
    
    private void minMouseClicked(MouseEvent evt) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addinterest(email,username).setVisible(true);
            }
        });
    }
